...
export default function BolgelerPage() {
  ...
  // Sütun başlıkları — KPI'lar (inline tanım, syntax sorunu yaşamamak için)
  type KpiHeader = { no:number; ad:string; kat:string; fmt:string; i:number; u:string }
  const kpiHeaders: KpiHeader[] = KPI_META.map(function(k, i) {
    return { no: k.no, ad: k.ad, kat: k.kat, fmt: k.fmt, i: i, u: kpiUnit(k.fmt) }
  })
