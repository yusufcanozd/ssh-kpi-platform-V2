...
const DASHBOARD_NAV: NavItem[] = [
  ...
  { href: '/dashboard/markalar', label: 'Marka Sıralaması',  icon: <UsersIcon /> },
...
const ADMIN_NAV: NavItem[] = [
  ...
  { href: '/admin/services',     label: 'Servis Noktaları',  icon: <HomeIcon /> },
  { href: '/admin/kpi',          label: 'KPI Veri Girişi',   icon: <ActivityIcon /> },
  { href: '/admin/submissions',  label: 'Gönderiler',        icon: <FileIcon /> },
  ...
  return (
    <aside className={styles.sidebar}>
      ...
      <div className={styles.brand}>
        <div className={styles.brandTag}>SSH · {variant === 'admin' ? 'Admin' : 'KPI Dashboard'}</div>
      ...
      <nav className={styles.nav}>
        ...
        {/* Çapraz geçiş */}
        <div className={styles.navGrp} style={{ marginTop: 8 }}>
          {variant === 'admin' ? 'Hızlı Erişim' : ''}
        </div>
        {variant === 'admin' && (
      ...
      <div className={styles.footer}>
        {profile && (
          <div className={styles.userBlock}>
            ...
            <div className={clsx(styles.userRole, styles[`role-${profile.role}`])}>
